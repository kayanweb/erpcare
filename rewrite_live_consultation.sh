cat << 'INNER_EOF' > src/components/LiveConsultationDashboard.tsx
import React, { useState } from "react";
import { Video, Calendar, Plus, Search, Users, Activity, Clock, PlayCircle, MoreHorizontal } from "lucide-react";
