  ...
  return (
    <div className={`p-6 max-w-5xl mx-auto space-y-6 ${isAr ? 'text-right' : 'text-left'}`} dir={isAr ? 'rtl' : 'ltr'}>
      ...
      <div className="bg-gradient-to-r from-emerald-900 to-teal-900 p-6 rounded-2xl shadow-xl border border-emerald-800 text-emerald-100 flex flex-col md:flex-row justify-between items-center gap-4">
        <div>
          <h1 className="text-2xl font-black text-emerald-400">NURSE AI HUB</h1>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
        ...
        <div className="space-y-3">
          {[
            ...
            <div key={task.id} className="flex items-center gap-4 p-4 rounded-xl border border-slate-100 bg-slate-50 hover:bg-slate-100 transition-colors">
