...
export default function SupervisorDailySuite({ language }: Props) {
  ...
  return (
    <div className="bg-slate-50 min-h-screen p-4 md:p-6 text-slate-800 font-sans" dir={isAr ? "rtl" : "ltr"}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 items-start">
        ...
        <div className="lg:col-span-3 space-y-4">
          ...
          {activeFormTab === "dailyReport" && (
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 bg-slate-50 p-4 border border-slate-200 rounded-xl text-xs font-bold text-slate-700">
                <div>
          ...
          {activeFormTab === "clinicalIndicators" && (
            <div className="space-y-6 animate-fade-in text-slate-800">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-1 sm:grid-cols-2 gap-6 font-sans">
          ...
          <div className="mt-12 pt-6 border-t-2 border-slate-800 grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-bold text-slate-700 avoid-break">
            <div>
