    ...
    <div className="p-6 bg-slate-50 min-h-full font-sans" dir={isAr ? "rtl" : "ltr"}>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        <div className="flex items-center gap-2 sm:gap-4 flex-wrap  w-full md:w-auto">
          ...
          <div className="w-10 h-10 sm:w-14 sm:h-14 bg-slate-800 rounded-2xl flex items-center justify-center text-white shadow-xl shadow-slate-200 shrink-0">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
             <div className="bg-white p-8 rounded-[2rem] border border-slate-200 shadow-sm flex flex-col items-center justify-center text-center min-h-[400px]">
                ...
                <h3 className="text-lg sm:text-2xl font-black text-slate-800 tracking-tight mb-2">Budget Utilization</h3>
      ...
      {activeTab === "hr" && (
        <div className="flex flex-col items-center justify-center min-h-[500px] bg-white rounded-3xl border border-slate-200 shadow-sm text-center p-8">
           ...
           <h3 className="text-lg sm:text-2xl font-black text-slate-800 tracking-tight mb-2">Human Resources System</h3>
      ...
      {activeTab === "inventory" && (
        <div className="flex flex-col items-center justify-center min-h-[500px] bg-white rounded-3xl border border-slate-200 shadow-sm text-center p-8">
           ...
           <h3 className="text-lg sm:text-2xl font-black text-slate-800 tracking-tight mb-2">Inventory Management</h3>
           <p className="text-slate-500 font-medium max-w-md mx-auto mb-8 leading-relaxed">
      ...
      {activeTab === "procurement" && (
        <div className="flex flex-col items-center justify-center min-h-[500px] bg-white rounded-3xl border border-slate-200 shadow-sm text-center p-8">
           ...
           <h3 className="text-lg sm:text-2xl font-black text-slate-800 tracking-tight mb-2">Procurement Engine</h3>
           <p className="text-slate-500 font-medium max-w-md mx-auto mb-8 leading-relaxed">
