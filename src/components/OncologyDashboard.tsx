                              ...
                              onClick={() =>
                                window.dispatchEvent(
                                  new CustomEvent("openGenericModal", {
                                    detail: {
                                      titleEn: "Dose calculation opened",
                                      titleAr: "Dose calculation opened",
                                      type: "form",
                                    },
                                  }),
                                )
                            ...
                            <button
                              onClick={() =>
                                window.dispatchEvent(
                                  new CustomEvent("openGenericModal", {
                                    detail: {
                                      titleEn: "Targeting opened",
                                      titleAr: "Targeting opened",
                                      type: "form",
                                    },
                                  }),
                                )
                          ...
                          <button
                            onClick={() =>
                              window.dispatchEvent(
                                new CustomEvent("openGenericModal", {
                                  detail: {
                                    titleEn: "Side effects logged",
                                    titleAr: "Side effects logged",
                                    type: "form",
                                  },
                                }),
                              )
