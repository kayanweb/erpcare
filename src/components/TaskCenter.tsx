...
export const TaskCenter: React.FC<TaskCenterProps> = ({ userRole, userId, onTaskSelect }) => {
  ...
  return (
    <div className="flex-1 flex flex-col h-full min-h-0 bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
      {/* Header */}
      <div className="p-4 border-b border-slate-100 bg-slate-50/50">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            <div className="w-5 h-5 sm:w-8 sm:h-8 rounded-lg bg-indigo-600 flex items-center justify-center text-white shadow-lg shadow-indigo-100">
          ...
          {filteredTasks.length === 0 ? (
            ...
            >
              <div className="w-16 h-16 rounded-full bg-slate-50 flex items-center justify-center mb-4">
                <CheckCircle2 className="w-5 h-5 sm:w-8 sm:h-8 opacity-20" />
              </div>
