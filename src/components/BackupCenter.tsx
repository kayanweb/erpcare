       ...
       <div className="grid grid-cols-1 lg:grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white border border-slate-200 rounded-[32px] p-8 shadow-sm flex flex-col md:flex-row items-center justify-between gap-8">
             <div className="flex items-center gap-6">
                ...
                <div>
                   <h2 className="text-2xl font-black text-slate-900">{isAr ? "نظام النسخ الاحتياطي" : "Disaster Recovery System"}</h2>
             ...
             <button className="px-8 py-4 bg-indigo-600 text-white rounded-[22px] font-black uppercase tracking-widest shadow-xl shadow-indigo-100 hover:bg-indigo-700 transition-all flex items-center gap-3 active:scale-95">
