...
export const AiHospitalBrain: React.FC<Props> = ({ patient, language }) => {
  ...
  return (
    <div className="bg-slate-900 rounded-[2.5rem] border border-white/10 shadow-2xl overflow-hidden flex-1 flex flex-col h-full min-h-0 font-sans text-white relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
           ...
           <div className="space-y-4">
              ...
              <button 
                ...
                className="w-full p-4 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 hover:border-indigo-500/50 transition-all flex items-center gap-2 sm:gap-4 flex-wrap  group"
              >
              ...
              <button 
                ...
                className="w-full p-4 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 hover:border-rose-500/50 transition-all flex items-center gap-2 sm:gap-4 flex-wrap  group"
              >
              ...
              <button className="w-full p-4 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 hover:border-emerald-500/50 transition-all flex items-center gap-2 sm:gap-4 flex-wrap  group">
              ...
              <button className="w-full p-4 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 hover:border-amber-500/50 transition-all flex items-center gap-2 sm:gap-4 flex-wrap  group">
        ...
        <div className="bg-gradient-to-r from-indigo-900/50 to-rose-900/50 p-6 rounded-3xl border border-white/10">
           ...
           <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="space-y-2">
                 ...
                 <div className="text-lg sm:text-2xl font-black text-emerald-400">Low (12%)</div>
              </div>
              <div className="space-y-2">
                 <p className="text-[10px] font-black text-white/40 uppercase tracking-tight">Sepsis Score</p>
                 <div className="text-lg sm:text-2xl font-black text-indigo-400">0.2</div>
              </div>
              <div className="space-y-2">
                 <p className="text-[10px] font-black text-white/40 uppercase tracking-tight">SLA Violation Risk</p>
                 <div className="text-lg sm:text-2xl font-black text-amber-400">Med (35%)</div>
              </div>
              <div className="space-y-2">
                 <p className="text-[10px] font-black text-white/40 uppercase tracking-tight">Fraud Detection</p>
                 <div className="text-lg sm:text-2xl font-black text-white/20">Inactive</div>
              </div>
           </div>
        </div>
      </div>
