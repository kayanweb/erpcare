  ...
  return (
    <div className="space-y-6 animate-fade text-right font-sans relative" dir="rtl">
      {onClose && (
        <button 
          onClick={onClose}
          className="absolute top-0 ltr:right-0 rtl:left-0 p-2 bg-slate-100 hover:bg-slate-200 rounded-xl transition-colors text-slate-500 z-dropdown no-print"
        >
          <X className="w-5 h-5" />
        </button>
      )}
      ...
      {authModal.open && (
        <div className="fixed inset-0 z-modal flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm shadow-2xl">
        ...
        <div className="space-y-6 text-right" dir="rtl">
          ...
          <div className="bg-gradient-to-r from-indigo-900 to-slate-950 text-white p-6 rounded-2xl border border-indigo-800 shadow-xl relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              ...
              <div className="bg-indigo-950/80 border border-indigo-800 p-3 rounded-xl flex flex-wrap items-center gap-2 sm:gap-3">
                <HeartPulse className="w-5 h-5 sm:w-8 sm:h-8 text-pink-500 animate-pulse" />
                ...
                <div>
                  ...
                  {simActiveResult ? (
                    <div className="mt-4 space-y-4 animate-fade text-right">
                      ...
                      {/* Vitals Summary */}
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 bg-slate-950 p-3 rounded-lg border border-slate-800 font-mono text-center">
                        <div>
              ...
              if (filtered.length === 0) {
                return (
                  <div className="text-center text-slate-400 py-10 space-y-2 border border-slate-100 rounded-xl">
                    <Database className="w-5 h-5 sm:w-8 sm:h-8 text-slate-300 mx-auto" />
                  ...
                  {filtered.map((log: any) => (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="bg-slate-100 p-2 rounded border border-slate-200 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 text-center text-[9px] font-mono mt-3 text-slate-700">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 w-full">
            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden flex items-center justify-between">
              <div>
                ...
                <h4 className="text-lg sm:text-2xl font-black text-slate-800 mt-1">
              ...
              <div className="relative shrink-0 w-10 h-10 sm:w-14 sm:h-14 flex items-center justify-center">
            ...
            <div className={`p-5 rounded-2xl border shadow-sm flex items-center justify-between transition-all ${
              ...
              <div className="text-right">
                ...
                <h4 className={`text-lg sm:text-2xl font-black mt-1 ${
            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex items-center justify-between">
              <div className="text-right">
                ...
                <h4 className="text-lg sm:text-2xl font-black text-pink-700 mt-1">
                  {jciCompletionRate}%
                </h4>
                <span className="text-[9px] text-slate-400 block mt-1 font-semibold">
                ...
                <div className="space-y-2.5 max-h-[300px] overflow-y-auto pr-1">
                  ...
                  {records.length === 0 ? (
                    <div className="p-3 bg-red-50/50 border border-red-200 rounded-xl relative flex items-start gap-3">
                      ...
                      <div className="w-5 h-5 sm:w-8 sm:h-8 rounded-full bg-rose-100 border border-rose-200 text-rose-600 flex items-center justify-center shrink-0">
                        <X className="h-4 w-4" />
                      </div>
                    </div>
                  ) : (
          ...
          <div className="bg-gradient-to-br from-purple-800 to-indigo-900 rounded-3xl p-6 text-white text-right shadow-md relative overflow-hidden">
            ...
            <div className="relative z-10 flex items-start justify-between">
              ...
              <div>
                ...
                <h2 className="text-lg sm:text-2xl font-black text-white">{isAr ? "مجلس التقارير الدورية والأداء" : "Periodic Performance Reports"}</h2>
              ...
              {periodicReports.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {periodicReports.map((rp: any) => (
                    <div key={rp.id} className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden flex-1 flex flex-col h-full min-h-0 text-right">
                      {rp.status === "Signed" && (
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-3 bg-slate-50 p-2 rounded-xl border border-slate-100">
        ...
        return (
          <div className="space-y-6 animate-fade">
            ...
            <div className="bg-white p-5 rounded-3xl border border-slate-200 shadow-sm flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-2 sm:gap-4 flex-wrap  text-right">
              ...
              <div className="flex flex-wrap items-center gap-2 sm:gap-3 self-stretch md:self-auto justify-end">
                  ...
                  <div className="bg-white rounded-3xl border border-slate-100 max-w-2xl w-full p-2 shadow-2xl relative animate-fade">
                    ...
                    >
                      ...
                      <div className="mt-6 space-y-4 text-xs font-sans text-right leading-relaxed">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 border-b border-dashed pb-2.5">
                        ...
                        <div className="bg-slate-50 p-5 rounded-2xl border border-slate-200 mt-6 space-y-3">
                          ...
                          {item.type === "audit" && (
                            <div className="space-y-2 text-[11px]">
                              ...
                              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 text-[9.5px]">
                      ...
                      <div className="mt-14 border-t-2 border-slate-900 pt-6 grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-sans text-right">
                        <div>
