    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-l from-slate-900 via-pink-950 to-slate-900 p-6 rounded-3xl border border-pink-500/30 text-right text-white shadow-xl relative overflow-hidden">
        {onClose && (
          <button 
            onClick={onClose}
            className="absolute top-2 ltr:right-2 rtl:left-2 p-2 hover:bg-white/20 rounded-2xl transition text-white/50 hover:text-white z-dropdown"
          >
            <X className="w-5 h-5" />
          </button>
        )}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white rounded-3xl border border-slate-200 shadow-sm p-6 text-right">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-slate-50/50 p-4 border border-slate-100 rounded-2xl grid grid-cols-1 sm:grid-cols-2 gap-4 text-center items-center">
                <button
      ...
      {activeSubTab === "isbar" && (
        <div className="grid grid-cols-1 xl:grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* LEFT: ISBAR FORM */}
              ...
              <div className="space-y-4 max-h-[620px] overflow-y-auto pr-1">
                {handoverList.map((item) => (
                  <div key={item.id} className="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm space-y-3 hover:border-pink-300 transition relative group">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 pt-1 text-[11px] leading-relaxed">
                      {/* S */}
