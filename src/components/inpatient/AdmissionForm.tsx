    ...
    <div className="max-w-5xl mx-auto space-y-8 pb-12">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="bg-white rounded-[40px] border border-slate-200 shadow-xl overflow-hidden">
           <div className="p-8 border-b border-slate-100 bg-slate-50/50 flex flex-wrap items-center gap-2 sm:gap-3">
        ...
        <div className="flex justify-end gap-4 pt-8">
           ...
           <button disabled={isSubmitting} type="submit" className="bg-indigo-600 hover:bg-indigo-700 disabled:bg-slate-300 text-white px-16 py-5 rounded-[24px] font-black shadow-2xl shadow-indigo-200 transition-all active:scale-95 flex items-center gap-2 sm:gap-4 flex-wrap sm:flex-nowrap w-full md:w-auto">
              {isSubmitting ? (
