    ...
    <div className="p-4 md:p-6 bg-slate-50 min-h-[calc(100vh-80px)] relative" style={{ direction: isAr ? "rtl" : "ltr" }}>
      ...
      <div className="w-full space-y-6">
        ...
        <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
          <div>
            <h1 className="text-xl md:text-lg sm:text-2xl font-black text-slate-900 flex items-center gap-2">
            ...
            {!isLoaded ? (
                  ...
                  return (
                    <div key={`arc-${doc.id}`} className="bg-slate-50 border border-slate-200 rounded-xl p-4 flex flex-col md:flex-row gap-4 justify-between items-start md:items-center">
                      <div>
                        ...
                        <div className="mt-1 flex items-center gap-2 sm:gap-4 flex-wrap  text-[10px] text-slate-500">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {filteredDocs.map((doc) => {
                  ...
                  return (
                    <div key={doc.id} className="relative group bg-white border border-slate-200 hover:border-pink-300 rounded-xl p-4 transition-all hover:shadow-md flex-1 flex flex-col h-full min-h-0">
