            ...
            {mainTabs.map(tab => (
              ...
              >
                ...
                {activeMainTab === tab.id && (
                  <motion.div layoutId="fo-tab-active" className="absolute bottom-0 left-0 w-full h-1 bg-indigo-600 rounded-t-full" />
                )}
              </button>
            ))}
         </div>
            ...
            <div className="h-full overflow-y-auto no-scrollbar p-8">
                       ...
                       <div className="bg-slate-900 rounded-[40px] p-10 text-white relative overflow-hidden flex flex-col justify-between shadow-2xl border border-slate-800">
                          ...
                          <div>
                             <div className="flex justify-between items-start mb-10">
                                <h3 className="text-2xl font-black tracking-tight leading-tight uppercase">{isAr ? "تنبيهات الاستقبال" : "Reception Alerts"}</h3>
               ...
               {["appointments", "visitors", "calls", "postal", "complaints", "search"].includes(activeMainTab) && (
                 <div className="flex-1 flex flex-col items-center justify-center p-20 text-center space-y-8">
                    ...
                    <div>
                       <h2 className="text-3xl font-black text-slate-800 uppercase tracking-tight">{isAr ? "مزامنة البيانات" : "Reception Data Sync"}</h2>
                       <p className="text-slate-400 font-bold max-w-md mx-auto mt-4 leading-relaxed uppercase tracking-widest text-sm">
                         {isAr ? "يتم الآن ربط موديول " + activeMainTab + " ضمن نظام الاستقبال الموحد" : "Linking " + activeMainTab + " data layer into the unified front office framework"}
                       </p>
                    </div>
