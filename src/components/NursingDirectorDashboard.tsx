...
export default function NursingDirectorDashboard({ language, currentUser, onNavigate }: Props) {
    ...
    <div className="p-4 md:p-6 bg-slate-50 min-h-screen text-right font-sans flex flex-col gap-6" dir={isAr ? "rtl" : "ltr"}>
      ...
      <div className="flex flex-col xl:flex-row gap-6 h-full items-stretch">
        ...
        <div className="flex-1 space-y-6">
          ...
          {activeTab === "kpi" && (
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-center">
          ...
          {activeTab === "training" && (
            <div className="grid grid-cols-1 lg:grid-cols-1 sm:grid-cols-2 gap-6 animate-fade-in">
              <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                <h3 className="text-sm font-black text-slate-800 mb-4 flex items-center gap-2">
          ...
          {activeTab === "department_heads" && (
            <div className="space-y-6 animate-fade-in">
              <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
