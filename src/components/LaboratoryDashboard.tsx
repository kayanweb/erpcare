                 ...
                 <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
                    <div className="bg-white rounded-[32px] border border-slate-200 shadow-sm overflow-hidden">
                       <div className="p-8 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                          <div>
                             <h2 className="text-2xl font-black text-slate-800 tracking-tight">{isAr ? "مخزون الكواشف والمستهلكات" : "Reagents & Consumables Inventory"}</h2>
                       ...
                       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
                          {[
                             ...
                             <div key={i} className="p-6 bg-slate-50 rounded-3xl border border-slate-100">
                                ...
                                <p className={`text-2xl font-black text-${metric.color}-600`}>{metric.value}</p>
                             </div>
                          ))}
                       </div>
                    </div>
                 ...
                 <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
                    <div className="bg-white rounded-[40px] border border-slate-200 shadow-sm p-10">
                       <div className="max-w-2xl mx-auto text-center mb-12">
                          <h3 className="text-2xl font-black text-slate-900 tracking-tight mb-4">{isAr ? "مركز أبحاث المختبر" : "Lab Search Center"}</h3>
                          ...
                          <div className="grid grid-cols-2 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                             {[
                                ...
                                <button key={i} className="p-6 bg-white border border-slate-200 rounded-3xl hover:border-indigo-500/50 hover:shadow-xl transition-all flex flex-col items-center gap-3 group">
                                   <cat.icon className="w-8 h-8 text-slate-300 group-hover:text-indigo-600 transition-colors" />
