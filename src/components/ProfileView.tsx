...
export default function ProfileView({ user, language, hospitalSettings, systemUsers = [], currentUser, onClose }: ProfileViewProps) {
  ...
  return (
    <div className="space-y-6 text-right font-sans" dir={isAr ? "rtl" : "ltr"}>
      ...
      {!isAuthorizedToView && (
        <div className="fixed inset-0 z-modal flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-md">
            ...
            <div className="space-y-6">
                ...
                <div className="bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900 text-white p-6 rounded-2xl shadow-md border border-slate-800 space-y-4">
                  ...
                  <div className="overflow-x-auto border border-slate-800 rounded-xl bg-slate-950 p-1.5 shadow-inner max-w-full">
                    <table className=" w-full text-center border-collapse text-xs font-semibold select-none">
                      <thead>
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200Space-y-4">
                  ...
                  <div className="grid grid-cols-2 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2.5">
                ...
                <div className="hidden print:block print-only p-6 font-sans text-right" dir="rtl">
                  ...
                  {/* Signatures */}
                  <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 gap-8 text-xs pt-6 text-center">
