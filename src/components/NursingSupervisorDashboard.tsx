...
export default function NursingSupervisorDashboard({ language, currentUser, onNavigate }: Props) {
      ...
      <div className="flex flex-col xl:flex-row gap-6 h-full items-stretch">
         ...
         <div className="flex-1 space-y-6 overflow-hidden">
            ...
            {activeTab === "forms" && activeForm === "none" && (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 animate-fade-in text-slate-800">
