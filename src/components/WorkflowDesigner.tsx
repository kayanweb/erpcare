...
export default function WorkflowDesigner({ language, onClose }: { language: 'ar' | 'en', onClose?: () => void }) {
  ...
  // Mock data for Admission Workflow
  ...
  return (
    <div className="space-y-6" dir={isAr ? 'rtl' : 'ltr'}>
       ...
       <div className="bg-white border border-slate-200 rounded-[32px] overflow-hidden shadow-sm flex flex-col h-[650px] relative">
          ...
          {/* Right Panel: Rules */}
          <div className="absolute ltr:right-6 rtl:left-6 top-28 w-72 bg-white/90 backdrop-blur-md border border-slate-200 rounded-[28px] shadow-2xl p-6 z-20 space-y-6">
       ...
       <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={i} className="flex items-center gap-3 px-4 py-3 bg-white border border-slate-100 rounded-xl">
