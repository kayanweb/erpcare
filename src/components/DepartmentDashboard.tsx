...
- **Critical Care Vigilance:** **3** unstable critical patients currently admitted, requiring intensive clinical surveillance.`
  ...
  const renderMarkdown = (text: string | null) => {
    ...
    return lines.map((line, index) => {
      ...
      if (line.startsWith("# ")) {
        return <h1 key={index} className="text-2xl font-black text-sky-800 mt-7 mb-4">{parseInlineStyles(line.slice(2))}</h1>;
      }
  ...
  return (
    <div className="p-6 space-y-6" dir={isAr ? 'rtl' : 'ltr'} id="department-dashboard-main">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4" id="stats-grid">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-1 sm:grid-cols-2 gap-6" id="dashboard-columns">
        ...
        <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden flex flex-col h-[650px] relative">
          ...
          <div className="flex items-center justify-between border-b border-slate-100 bg-slate-50 px-6 py-4">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-xl bg-gradient-to-tr from-sky-500 to-indigo-600 text-white flex items-center justify-center shadow-md animate-pulse">
                ...
                <div className="flex-1 space-y-3 overflow-y-auto max-h-[440px] pr-2 custom-scrollbar">
                  ...
                  {loadingChat && (
                    <div className="flex justify-start">
                      <div className="bg-slate-100 rounded-2xl rounded-bl-none p-4 max-w-[80%] border border-slate-200 flex items-center gap-3">
