          ...
          <div className="space-y-4">
            <div className="bg-white p-5 rounded-2xl shadow-sm border border-slate-200">
              ...
              <div className="space-y-3">
                ...
                <button className="w-full bg-amber-50 hover:bg-amber-100 text-amber-700 p-3 rounded-xl flex flex-wrap items-center gap-2 sm:gap-3 transition border border-amber-200">
