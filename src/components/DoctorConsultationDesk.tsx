...
export default function DoctorConsultationDesk({ language, currentUser, systemUsers, departments, onNavigate, forcedPatientId, isEmbedded }: Props) {
  ...
  return (
    <div className="flex-1 flex flex-col h-full min-h-0 bg-slate-50 font-sans" dir={isAr ? "rtl" : "ltr"}>
          ...
          <div className="lg:col-span-5 space-y-6 flex flex-col">
            ...
            {activeTab === "Vitals" && (
              <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-sm flex-1 space-y-5">
                ...
                <div className="grid grid-cols-2 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                  {[
                    ...
                    {vitalsHistory.length === 0 ? (
                      ...
                      vitalsHistory.map((item, idx) => (
                        ...
                        >
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-1.5 text-center">
      ...
      {!isEmbedded && (
        ...
        <div className="flex items-center justify-between px-4 py-2 sm:py-3 border-b border-slate-100 flex-wrap  gap-2">
              ...
              queuePatients.map((p, idx) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    <img src={`https://i.pravatar.cc/150?u=${p.id}`} className="w-5 h-5 sm:w-8 sm:h-8 rounded-full shadow-xs" alt="pic" referrerPolicy="no-referrer" />
      ...
      {/* 1. Modal: Edit Vitals */}
      {isEditVitalsOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4 z-dropdown animate-fade" dir={isAr ? "rtl" : "ltr"}>
      ...
      {detailModal.isOpen && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-md flex items-center justify-center p-4 z-modal animate-fade" dir={isAr ? "rtl" : "ltr"}>
