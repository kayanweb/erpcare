          ...
          <div className="p-8 border-b border-slate-100 bg-slate-50/50 flex items-center justify-between">
             <div className="flex flex-wrap items-center gap-2 sm:gap-3 sm:gap-5 flex-wrap ">
                ...
                <div className="w-16 h-16 bg-indigo-600 rounded-[24px] flex items-center justify-center shadow-xl shadow-indigo-100 border-2 border-indigo-50 shrink-0">
                   <Cloud className="w-5 h-5 sm:w-8 sm:h-8 text-white" />
                </div>
                <div>
             ...
             <div className="space-y-6">
                ...
                <div className="bg-white border border-slate-100 rounded-[32px] p-6 shadow-sm space-y-4">
                   ...
                   <div className="flex flex-col gap-2">
                      <button className="flex flex-wrap items-center gap-2 sm:gap-3 p-3 hover:bg-slate-50 rounded-xl transition text-right rtl:text-right ltr:text-left">
