...
export default function GenericActionModal() {
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/70 backdrop-blur-md z-modal flex items-center justify-center p-2 sm:p-4 transition-all duration-300" dir={isAr ? "rtl" : "ltr"}>
          ...
          <AnimatePresence mode="wait">
            ...
            {activeTab === "clinical" && (
              ...
              >
                ...
                <div className="bg-slate-900 text-white rounded-2xl p-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-4">
                    ...
                    <div className="grid grid-cols-2 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 text-xs">
                      <div>
