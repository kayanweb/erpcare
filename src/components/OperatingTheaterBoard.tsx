      ...
      <div className="bg-white border-b border-slate-200 px-4 sm:px-8 py-4 sm:py-5 flex flex-col xl:flex-row xl:items-center justify-between gap-4 shadow-sm z-30 shrink-0">
        <div className="flex flex-wrap items-center gap-2 sm:gap-3 sm:gap-5 flex-wrap ">
          <div className="w-10 h-10 sm:w-14 sm:h-14 bg-rose-600 rounded-[22px] flex items-center justify-center shadow-xl shadow-rose-100 border-2 border-rose-50">
            <Scissors className="w-5 h-5 sm:w-8 sm:h-8 text-white" />
          </div>
          <div>
                      ...
                      <div className="bg-white rounded-[32px] border border-slate-200 p-8 shadow-sm">
                         ...
                         <div className="space-y-4">
                            {[
                              ...
                              <div key={i} className="flex items-center gap-2 sm:gap-4 flex-wrap  p-4 bg-slate-50 rounded-2xl border border-slate-100">
                       ...
                       <div className="bg-slate-900 rounded-[40px] p-10 text-white relative overflow-hidden flex flex-col justify-between shadow-2xl border border-slate-800">
                          ...
                          <div>
                             <div className="flex justify-between items-start mb-10">
                                <h3 className="text-lg sm:text-2xl font-black tracking-tight leading-tight uppercase">{isAr ? "إحصائيات الكفاءة" : "Efficiency Metrics"}</h3>
                 ...
                 <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
                    <div className="bg-white rounded-[32px] border border-slate-200 shadow-sm overflow-hidden">
                       <div className="p-8 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                          <div>
                             <h2 className="text-lg sm:text-2xl font-black text-slate-800 tracking-tight">{isAr ? "جدول العمليات الرئيسي" : "Main Surgical Schedule"}</h2>
                             ...
                             <div className="space-y-4">
                                {[
                                   ...
                                   <div key={i} className="p-6 bg-slate-50 rounded-[28px] border border-slate-100 flex items-center justify-between">
                                      <div className="flex flex-wrap items-center gap-2 sm:gap-3 sm:gap-5 flex-wrap ">
                                         <div className={`w-10 h-10 sm:w-14 sm:h-14 rounded-2xl flex items-center justify-center font-black text-lg border-2 ${p.score >= 9 ? 'bg-emerald-50 border-emerald-100 text-emerald-600' : 'bg-amber-50 border-amber-100 text-amber-600'}`}>
                                            {p.score}
                                         </div>
                                         <div>
                 ...
                 <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
                    <div className="bg-white rounded-[40px] border border-slate-200 shadow-sm p-10">
                       <div className="max-w-2xl mx-auto text-center mb-12">
                          <h3 className="text-lg sm:text-2xl font-black text-slate-900 tracking-tight mb-4">{isAr ? "أرشيف الجراحة الذكي" : "Smart Surgical Archive"}</h3>
                          ...
                          <div className="grid grid-cols-2 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                             {[
                                ...
                                <button key={i} className="p-6 bg-white border border-slate-200 rounded-3xl hover:border-rose-500/50 hover:shadow-xl transition-all flex flex-col items-center gap-3 group">
                                   <cat.icon className="w-5 h-5 sm:w-8 sm:h-8 text-slate-300 group-hover:text-rose-600 transition-colors" />
