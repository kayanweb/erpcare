            ...
            <div className="h-full overflow-y-auto no-scrollbar p-8">
               ...
               {["inventory", "donors", "requests", "crossmatch", "search"].includes(activeMainTab) && (
                 <div className="flex-1 flex flex-col items-center justify-center p-20 text-center space-y-8">
                    ...
                    <div>
                       <h2 className="text-3xl font-black text-slate-800 uppercase tracking-tight">{isAr ? "مزامنة الأنظمة" : "Blood Bank Sync"}</h2>
                       <p className="text-slate-400 font-bold max-w-md mx-auto mt-4 leading-relaxed uppercase tracking-widest text-sm">
                         {isAr ? "يتم الآن ربط قاعدة بيانات " + activeMainTab + " ضمن نظام بنك الدم الموحد" : "Linking " + activeMainTab + " data layer into the unified blood bank framework"}
                       </p>
                    </div>
