      ...
      <div className="flex items-center gap-2 sm:gap-6 shrink-0">
        ...
        <div className="flex items-center gap-1.5 sm:gap-5">
          ...
          <div className="relative">
            <div
              onClick={() => setInternalIsProfileDropdownOpen(!internalIsProfileDropdownOpen)}
            ...
            {internalIsProfileDropdownOpen && (
              <div className={`absolute mt-2 w-56 sm:w-64 rounded-2xl bg-white p-2 shadow-2xl border border-slate-200 z-dropdown ${isAr ? "left-0" : "right-0"}`}>
                ...
                <button onClick={() => { setInternalIsProfileDropdownOpen(false); /* Navigate to profile */ }} className="w-full flex flex-wrap items-center gap-2 sm:gap-3 px-4 py-3 text-sm font-bold text-slate-700 hover:bg-slate-50 rounded-xl transition">
