...
export const HISRibbon: React.FC<HISRibbonProps> = ({
  ...
  return (
    <div className="bg-white border-b border-slate-200 shrink-0 shadow-sm z-10 sticky top-[64px] sm:top-[80px]">
          ...
          {activeModule.subItems.map((sub) => {
            ...
            return (
              <button
                ...
                className={`whitespace-nowrap px-4 py-2 text-sm font-bold rounded-lg transition-all duration-200 ${isActive ? "bg-indigo-600 text-white shadow-md shadow-indigo-200 border-indigo-600" : "text-slate-600 hover:bg-slate-100 hover:text-slate-900 border border-transparent"}`}
              >
