    ...
    <div className="flex flex-col h-full bg-[#f8fafc]" dir={isAr ? "rtl" : "ltr"}>
      ...
      <div className="bg-white border-b border-slate-200 px-8 py-6 flex flex-col md:flex-row md:items-center justify-between gap-6 shadow-sm z-30">
        <div className="flex items-center gap-5">
           <div className="w-14 h-14 bg-sky-900 rounded-[22px] flex items-center justify-center shadow-xl shadow-sky-100 border-2 border-sky-800 shrink-0">
        ...
        <AnimatePresence mode="wait">
          ...
          {activeTab === "appointments" && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="bg-white rounded-[40px] border border-slate-200 shadow-sm p-12 text-center">
               ...
               <h3 className="text-2xl font-black text-slate-800 tracking-tight">{isAr ? "إدارة مواعيد العيادة" : "Full Clinic Calendar Management"}</h3>
