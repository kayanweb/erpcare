...
export const QueueManagement: React.FC<Props> = ({ department, language }) => {
  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-200 shadow-sm flex-1 flex flex-col h-full min-h-0 overflow-hidden font-sans" dir={isAr ? "rtl" : "ltr"}>
      {/* Header */}
           ...
           <div className="flex-1 overflow-y-auto p-4 space-y-3">
              ...
              {queue.length === 0 && (
                <div className="py-20 text-center space-y-3">
                   <Users className="w-5 h-5 sm:w-8 sm:h-8 text-slate-100 mx-auto" />
