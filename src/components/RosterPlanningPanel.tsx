        ...
        {activeTab === "dashboard" && (
          <div className="space-y-6">
            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-3">
              ...
              <div className="grid grid-cols-2 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 pt-2">
          ...
          <div className="bg-gradient-to-l from-pink-50 to-rose-50 border border-pink-100 p-6 rounded-2xl shadow-sm flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="grid grid-cols-2 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 w-full md:w-auto">
          ...
          {settings.تفعيل_تنبيه_النواقص && (
            <div className="bg-amber-50/70 border border-amber-200/80 p-5 rounded-2xl shadow-sm space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 max-h-96 overflow-y-auto pr-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <form onSubmit={handleApplyOverride} className="lg:col-span-1 bg-white rounded-3xl border border-slate-200 shadow-xl overflow-hidden flex flex-col relative">
              ...
              <div className="p-6 space-y-5 flex-1">
                ...
                <div className="p-4 bg-slate-100 rounded-2xl border border-slate-200 grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {/* Duration choice */}
                  <div className="space-y-2">
