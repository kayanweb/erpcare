    ...
    <div className="flex flex-col h-full bg-[#f8fafc]" dir={isAr ? "rtl" : "ltr"}>
      ...
      <div className="bg-white border-b border-slate-200 px-8 py-5 flex items-center justify-between shadow-sm z-30">
        <div className="flex items-center gap-5">
          <div className="w-14 h-14 bg-amber-600 rounded-[22px] flex items-center justify-center shadow-xl shadow-amber-100 border-2 border-amber-50">
      ...
      {/* Navigation Tabs */}
      <div className="bg-white border-b border-slate-200 px-8 flex items-center justify-between sticky top-0 z-20 overflow-x-auto no-scrollbar">
         <div className="flex gap-2">
            {tabs.map(tab => (
              ...
              >
                ...
                {isAr ? tab.ar : tab.en}
                {activeTab === tab.id && (
                  <motion.div layoutId="rcm-tab" className="absolute bottom-0 left-0 right-0 h-1 bg-amber-600 rounded-t-full" />
                )}
              </button>
            ))}
         </div>
                    ...
                    <div className="bg-slate-900 rounded-[40px] p-10 text-white relative overflow-hidden flex flex-col justify-between shadow-2xl">
                       ...
                       <div>
                          <div className="flex justify-between items-start mb-10">
                             <h3 className="text-2xl font-black tracking-tight leading-tight uppercase">{isAr ? "تحليل الرفض التأميني" : "Claim Denial Root Cause"}</h3>
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
                 <div className="bg-white rounded-[32px] border border-slate-200 shadow-sm overflow-hidden">
                    <div className="p-8 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                       <h2 className="text-2xl font-black text-slate-800 tracking-tight">{isAr ? "مركز المطالبات الإلكترونية" : "Electronic Claims Clearinghouse"}</h2>
                       <div className="flex gap-4">
            ...
            {activeTab === "ledger" && (
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
                 <div className="bg-white rounded-[40px] border border-slate-200 shadow-sm overflow-hidden">
                    <div className="p-8 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                       <div>
                          <h2 className="text-2xl font-black text-slate-800 tracking-tight">{isAr ? "السجل المالي الموحد" : "Unified Financial Ledger"}</h2>
