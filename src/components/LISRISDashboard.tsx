...
export default function LISRISDashboard({ language, onClose }: Props) {
  ...
  const handleAutoSimulateValues = (type: "normal" | "critical") => {
    ...
    if (catItem) {
      ...
      window.dispatchEvent(new CustomEvent("openGenericModal", { detail: { titleEn: "sample values simulated successfully!", titleAr: "تم محاكاة عينات التحليل فورياً", type: "form" } }));
    }
  };
