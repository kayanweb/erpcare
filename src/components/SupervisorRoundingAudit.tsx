      ...
      <div className="space-y-6 animate-fade-in">
        ...
        <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm print:shadow-none print:border-none print:m-0 print:p-0" ref={printRef}>
          <div className="space-y-6 w-full print:w-full" dir={isAr ? "rtl" : "ltr"}>
            ...
            <div className="grid grid-cols-2 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 bg-slate-50 p-4 border border-slate-200 rounded-xl mb-6 font-bold text-sm text-slate-800 print:bg-white print:border-slate-800 print:border-2">
              <div>
