            ...
            <div className="h-full overflow-y-auto no-scrollbar p-8">
               ...
               {["templates", "materials", "guidelines", "archive", "search"].includes(activeMainTab) && (
                 <div className="flex-1 flex flex-col items-center justify-center p-20 text-center space-y-8">
                    <div className="w-32 h-32 bg-cyan-50 rounded-[48px] flex items-center justify-center shadow-inner border border-indigo-100">
                    ...
                    <div>
                       <h2 className="text-3xl font-black text-slate-800 uppercase tracking-tight">{isAr ? "مزامنة المستودع" : "Repository Sync"}</h2>
                       <p className="text-slate-400 font-bold max-w-md mx-auto mt-4 leading-relaxed uppercase tracking-widest text-sm">
                         {isAr ? "يتم الآن ربط موديول " + activeMainTab + " ضمن نظام إدارة المحتوى الموحد" : "Linking " + activeMainTab + " data layer into the unified document management framework"}
                       </p>
                    </div>
