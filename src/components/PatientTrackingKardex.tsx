              ...
              <div className="p-8 border-b border-slate-100 bg-slate-900 text-white relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
                  <div className="flex items-center gap-5">
                    ...
                    <div>
                      <h2 
                        className="text-2xl font-black tracking-tight mb-1 cursor-pointer hover:text-indigo-300 transition" 
                ...
                <div className="relative z-10 mt-8 grid grid-cols-2 sm:grid-cols-3 gap-4">
