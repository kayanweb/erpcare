          ...
          <AnimatePresence mode="wait">
             {activeStage === 'SEARCH' && (
               ...
               >
                  ...
                  <h2 className="text-2xl font-black text-slate-900 mb-2">{isAr ? "التحقق من الهوية" : "Identity Verification"}</h2>
                  ...
                  <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-md">
                     <button className="flex items-center gap-3 p-4 bg-white border border-slate-100 rounded-2xl hover:border-indigo-200 transition-all shadow-sm">
             ...
             {activeStage === 'REGISTRATION' && (
                ...
                >
                   <div className="flex items-center justify-between mb-12">
                      <div>
                         <h2 className="text-2xl font-black text-slate-900 tracking-tight">{isAr ? "تسجيل مريض جديد" : "New Patient Registration"}</h2>
             ...
             {activeStage === 'BOOKING' && (
                ...
                >
                   <div className="flex items-center justify-between mb-12">
                      <h2 className="text-2xl font-black text-slate-900 tracking-tight">{isAr ? "بدء زيارة المريض" : "Visit Initiation"}</h2>
